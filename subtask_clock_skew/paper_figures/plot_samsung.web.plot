...
figure_dir = "./figures"
data_dir = "./output"
set output figure_dir."/2013.07.12.Samsung_iphone.web_youtube.pcap.txt.eps"
...
plot data_dir."/2013.07.12.Samsung_iphone.web_youtube.pcap.txt.10.0.2.8.offset.txt" using 3:6 with points ls 1 title "10.0.2.8", \
1.21956211639344e-05*x - 0.00418102748059291 ls 2 notitle