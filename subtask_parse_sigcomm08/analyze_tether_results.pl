...
# Variables
#############
my $input_dir  = "../processed_data/subtask_parse_sigcomm08/statistics";
...
foreach my $i (5) {
    foreach my $j (1,2,5) {
        push(@filenames, "results.tether.sigcomm08.4.filter.dup1.host$ratio.bt0.s$i--sigcomm08.4.filter.dup1.host0.3.bt0.s$j.txt");
    }
}
