...
scaled_file = "tmp." + file_name + ".scale"
model_file = "tmp." + file_name + ".model"
range_file = "tmp." + file_name + ".range"

if len(sys.argv) > 2:
	test_pathname = sys.argv[2]
	file_name = os.path.split(test_pathname)[1]
	assert os.path.exists(test_pathname),"testing file not found"
	scaled_test_file = "tmp." + file_name + ".scale"
	predict_test_file = train_pathname + "--" + file_name + ".predict"
