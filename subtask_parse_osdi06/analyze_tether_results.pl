...
# Variables
#############
my $input_dir  = "../processed_data/subtask_parse_osdi06/statistics";
...
foreach my $i (5) {
    foreach my $j (1 .. 3) {
        push(@filenames, "results.tether.osdi06.A.filter.dup1.host$ratio.bt0.s$i--osdi06.A.filter.dup1.host0.3.bt0.s$j.txt");
    }
}
