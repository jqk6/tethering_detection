...
##
## - e.g.
##    perl gen_trace.sigcomm04.pl chihuahuan-ath2.02.filter 1 0.3 0 1
##
##########################################
...
# Variables
#############
my $input_dir  = "../processed_data/subtask_parse_sigcomm04/tshark";
my $output_dir = "../processed_data/subtask_parse_sigcomm04/gen_trace";
my $filename;
my $ratio_dup;
my $ratio_host;
my $bt_diff;
