...
##
##  e.g.
##    perl statistics.sigcomm04.v2.pl chihuahuan-ath2.02.filter.dup1.host0.3.bt0.s1
##
##########################################
...
# Variables
#############
my $input_dir  = "../processed_data/subtask_parse_sigcomm04/gen_trace";
my $output_dir = "../processed_data/subtask_parse_sigcomm04/statistics";
my $output_prob_dir = "../processed_data/subtask_parse_sigcomm04/prob";
my $output_dect_dir = "../processed_data/subtask_parse_sigcomm04/detection";
...
foreach my $this_ip (keys %{ $ip_info{SRC} }) {
    ...
    my @freqs = (1, 2, 10, 100, 125, 128, 200, 256, 1000);
