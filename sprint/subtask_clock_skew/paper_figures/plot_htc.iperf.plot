...
figure_dir = "./figures"
data_dir = "./output"
set output figure_dir."/2013.07.11.HTC.iperf.2min.pcap.txt.eps"
...
plot data_dir."/2013.07.11.HTC.iperf.2min.pcap.txt.10.0.2.5.offset.txt" using 3:6 with points ls 1 title "10.0.2.5", \
1.63472433457858e-05*x - 0.0446660333772759 ls 2 notitle