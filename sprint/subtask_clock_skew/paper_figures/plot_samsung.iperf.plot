...
figure_dir = "./figures"
data_dir = "./output"
set output figure_dir."/2013.07.11.Samsung.iperf.2min.pcap.txt.eps"
...
plot data_dir."/2013.07.11.Samsung.iperf.2min.pcap.txt.10.0.2.8.offset.txt" using 3:6 with points ls 2 title "10.0.2.8", \
1.09542003123405e-05*x - 0.0208502124366382 ls 1 notitle