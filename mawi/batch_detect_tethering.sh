...
echo "text 5, exp=2, ratio=0.002"
perl replace_ip.pl text5 2 0.02
echo "text 5, exp=3, ratio=0.003"
perl replace_ip.pl text5 3 0.03
echo "text 5, exp=4, ratio=0.004"
perl replace_ip.pl text5 4 0.04
echo "text 5, exp=5, ratio=0.005"
perl replace_ip.pl text5 5 0.05
echo "text 5, exp=6, ratio=0.006"
perl replace_ip.pl text5 6 0.06
echo "text 5, exp=7, ratio=0.01"
