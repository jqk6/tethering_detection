...
##
## - e.g.
##    perl gen_trace.sim.pl sim.i5.a5.w5.s1 1 0.2 0 1
##
##########################################
...
# Variables
#############
my $input_dir  = "../processed_data/subtask_sim_trace/tshark";
my $output_dir = "../processed_data/subtask_sim_trace/gen_trace";
my $filename;
my $ratio_dup;
my $ratio_host;
my $bt_diff;
