...
file_name = "sjtu_wifi.filter.dup1.host0.2.bt0.s3.bt"
fig_name  = "testbed.filter.dup1.host0.2.bt0.s3.bt"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 Stdev of calculated boot time}' offset character 0, 0, 0
set ylabel '{/Helvetica=28 Pr(Stdev of boot time > x)}' offset character 0, 0, 0
...
plot data_dir.file_name.".txt" using 3:1 with linespoints ls 1 title '{/Helvetica=28 tethering devices}', \
  "" using 4:1 with linespoints ls 2 title '{/Helvetica=28 normal devices}'
