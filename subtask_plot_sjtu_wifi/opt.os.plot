...
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.opt.os"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.opt.os"
...
# set key left top
set key at 3.2,1 samplen 2.5 width -1
...
plot data_dir.file_name.".txt" using 2:xtic(1) fs pattern 2 ls 1 t '{/Helvetica=24 no Opt}', \
     "" using 3:xtic(1) fs pattern 3 ls 2 t '{/Helvetica=24 WS Opt}', \
     "" using 4:xtic(1) fs pattern 4 ls 3 t '{/Helvetica=24 TS Opt}'
