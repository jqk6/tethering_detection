...
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.wsf.os"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.wsf.os"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 ratio of used WS}' offset character 0, 0, 0
set ylabel '{/Helvetica=28 Pr(ratio of WS=w > x)}' offset character 0, 0, 0
...
plot data_dir.file_name.".txt" using 5:1 with linespoints ls 1 title '{/Helvetica=28 Android:WS=64}', \
  "" using 6:1 with linespoints ls 2 title '{/Helvetica=28 iOS:WS=16}', \
  "" using 3:1 with linespoints ls 3 title '{/Helvetica=28 Windows:WS=4}'#, \
  # "" using 4:1 with linespoints ls 4 title '{/Helvetica=28 Windows:WS=256}'
