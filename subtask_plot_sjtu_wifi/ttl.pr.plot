...
file_name = "sjtu_wifi.filter.dup1.host0.2.bt0.s1.sjtu_wifi.filter.dup1.host0.2.bt0.s4.ttl"
fig_name  = "testbed.filter.dup1.host0.2.bt0.s1.s4.ttl"
...
plot data_dir.file_name.".txt" using 4:3 with linespoints ls 1 #title '{/Helvetica=28 TITLE_1}', \
