...
file_name = "sjtu_wifi.filter.dup1.host0.2.bt0.s3.freq"
fig_name  = "testbed.filter.dup1.host0.2.bt0.s3.freq"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 Stdev of calculated frequency}' offset character 0, 0, 0
set ylabel '{/Helvetica=28 Pr(Stdev of freq > x)}' offset character 0, 0, 0
