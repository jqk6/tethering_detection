...
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.ip_id_mono.os.pkt"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.ip_id_mono.os.pkt"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 ratio of packets violating IP ID monotonicity}' offset character 0, 0, 0
...
plot data_dir.file_name.".txt" using 2:1 with linespoints ls 1 title '{/Helvetica=28 Android}', \
  "" using 3:1 with linespoints ls 2 title '{/Helvetica=28 iOS}', \
  "" using 4:1 with linespoints ls 3 title '{/Helvetica=28 Windows}'
...
data_dir = "../processed_data/subtask_parse_sjtu_wifi/statistics/"
fig_dir  = "../processed_data/subtask_plot_sjtu_wifi/figures/"
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.ip_id_mono.os.flow"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.ip_id_mono.os.flow"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 ratio of flows violating IP ID monotonicity}' offset character 0, 0, 0
set ylabel '{/Helvetica=28 CDF}' offset character 0, 0, 0
