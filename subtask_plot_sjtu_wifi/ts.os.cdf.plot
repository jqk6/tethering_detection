...
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.ts.os"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.ts.os"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 ratio of pkts with TCP Timestamp Option}' offset character 0, 0, 0
set ylabel '{/Helvetica=28 Pr(TCP TS Opt ratio > x)}' offset character 0, 0, 0
...
# set key right top samplen 1.5 width -1
set key at 1.1,1
...
plot data_dir.file_name.".txt" using 3:1 with linespoints ls 1 title '{/Helvetica=22 Android}', \
  "" using 4:1 with linespoints ls 2 title '{/Helvetica=22 iOS}', \
  "" using 5:1 with linespoints ls 3 title '{/Helvetica=22 Windows}'
