...
##
##  e.g.
##      perl detect_tethering_connections.pl 49
##
##################################################
...
foreach my $this_timebin (@timebins) {
    my $file_name = "file.$file_id.connections.bin$this_timebin.txt";
...
foreach my $this_timebin (@timebins) {
    foreach my $this_threshold (@thresholds) {
        my $file_output = "Connections_timebin$this_timebin.threshold$this_threshold.$file_id.txt";
