...
file_name = "testbed.exp1.filter.dup1.host0.bt0.s1.ip_id_mono.os.pkt"
fig_name  = "testbed.exp1.filter.dup1.host0.bt0.s1.ip_id_mono.os.pkt"
...
set ylabel '{/Helvetica=28 Pr[ratio of pkts <= x]}' offset character 0, 0, 0
...
plot data_dir.file_name.".txt" using 3:2 with linespoints ls 1 title '{/Helvetica=28 Android}', \
  "" using 4:2 with linespoints ls 2 title '{/Helvetica=28 iOS}', \
  "" using 5:2 with linespoints ls 3 title '{/Helvetica=28 Windows}'
