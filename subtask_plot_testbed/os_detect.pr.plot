...
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.os_detect.Windows"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.os_detect.Windows"
...
plot data_dir.file_name.".txt" using 2:xtic(1) fs pattern 2 ls 1 t '{/Helvetica=24 Precision}', \
     "" using 3:xtic(1) fs pattern 3 ls 2 t '{/Helvetica=24 Recall}'
...
data_dir = "../processed_data/subtask_parse_sjtu_wifi/statistics/"
fig_dir  = "../processed_data/subtask_plot_sjtu_wifi/figures/"
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.os_detect.Android"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.os_detect.Android"
set output fig_dir.fig_name.".eps"
...
# set key left top
set key at 2.2,1.1 horizontal samplen 2.5 width -1
# set key Left under reverse horizontal spacing 0.9 samplen 1.5 width -1
# set nokey
...
data_dir = "../processed_data/subtask_parse_sjtu_wifi/statistics/"
fig_dir  = "../processed_data/subtask_plot_sjtu_wifi/figures/"
file_name = "sjtu_wifi.filter.dup1.host0.bt0.s1.os_detect.Apple"
fig_name  = "testbed.filter.dup1.host0.bt0.s1.os_detect.Apple"
set output fig_dir.fig_name.".eps"
