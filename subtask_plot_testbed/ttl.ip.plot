...
file_name = "testbed.exp1.filter.dup1.host0.bt0.s1.ttl.ip"
fig_name  = "testbed.exp1.filter.dup1.host0.bt0.s1.ttl.ip"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 # of distinct TTL values from an IP}'
