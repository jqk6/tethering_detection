...
file_name = "testbed.exp1.filter.dup1.host0.3.bt0.s1.bt"
fig_name  = "testbed.exp1.filter.dup1.host0.3.bt0.s1.bt"
...
plot data_dir.file_name.".txt" using 3:1 with linespoints ls 1 title '{/Helvetica=28 tethering}', \
  "" using 4:1 with linespoints ls 2 title '{/Helvetica=28 normal}'
