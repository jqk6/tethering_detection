...
file_name = "testbed.exp1.filter.dup1.host0.bt0.s1.wsf.os"
fig_name  = "testbed.exp1.filter.dup1.host0.bt0.s1.wsf.os"
...
plot newhistogram "Android",\
     data_dir.file_name.".Android.txt" using 4:xtic(1) fs pattern 2 ls 1, \
     newhistogram "iOS",\
     data_dir.file_name.".Apple.txt" using 4:xtic(1) fs pattern 3 ls 2, \
     newhistogram "Windows",\
     data_dir.file_name.".Windows.txt" using 4:xtic(1)  fs pattern 4 ls 3
