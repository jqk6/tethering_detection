 ...
 * - internal variables
 *     a) RUN_DBSCAN: 
 *          true: run dbscan clustering method.
 *          note that DBSCAN in Weka doesn't work well. 
 *          See group_by_tcp_timestamp_elki.java for ELKI version.
 *
...
public class group_by_tcp_timestamp 
{
    ...
    *************************/
    ...
    /* Constant */
    private static boolean RUN_DBSCAN = false;  /* true: run dbscan clustering method.
                                                   note that DBSCAN in Weka doesn't work well. 
                                                   See group_by_tcp_timestamp_elki.java for ELKI version. */
