...
##
##  e.g.
##    perl statistics.testbed.v3.pl testbed.filter.dup1.host0.2.bt0.s1
##    perl statistics.testbed.v3.pl testbed.filter.dup1.host0.bt0.s1 testbed.filter.dup1.host0.bt0.s1
##
##########################################
...
foreach my $this_tethering (0, 1){
    foreach my $this_ip (sort (keys %{ $out_info{IP} })) {
        ...
        print FH "$this_ip=".$out_info{IP}{$this_ip}{OS}."|$this_tethering, $pr_tethering, ";
