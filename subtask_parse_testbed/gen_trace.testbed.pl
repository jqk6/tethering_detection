...
##
## - e.g.
##    perl gen_trace.testbed.pl testbed.filter 1 0.2 0 1
##    perl gen_trace.testbed.pl testbed.sjtu.filter 1 0.2 0 1
##
##########################################
...
my $output_dir = "../processed_data/subtask_parse_testbed/gen_trace";
my $filename;
my $ratio_dup;
my $ratio_host;
my $bt_diff;
