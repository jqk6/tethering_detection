...
my $ratio = 0.3;
my @filenames = ("trainexp2.testexp3.weka.txt"
                 , "trainexp4.testexp5.weka.txt"
                 # , "trainexp6.testexp7.weka.txt"
                 , "trainexp8.testexp9.weka.txt"
                 # , "trainexp10.testexp11.weka.txt"
                 , "trainexp1.testexp3.weka.txt"
                 , "trainexp1.testexp6.weka.txt"
                 , "trainexp1.testexp10.weka.txt"
                );
