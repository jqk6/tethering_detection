...
# set key right top
# set key at 2.5,1.1
# set key at -1,1.26 Left left reverse nobox horizontal spacing 1 samplen 2 width 0.8
set key at -1.2,1.26 Left left reverse nobox horizontal spacing 1 samplen 1.5 width 0
# set nokey
...
plot data_dir.file_name.".txt" using 2:xtic(1) fs pattern 2 ls 1 title '{/Helvetica=28 WS=1}', \
     ...
     data_dir.file_name.".txt" using 5:xtic(1) fs pattern 5 ls 4 title '{/Helvetica=28 WS=8}', \
