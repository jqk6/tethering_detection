...
file_name = "ipid_mono.violation.data"
fig_name  = "ipid_mono.violation.data"
...
plot data_dir.file_name.".txt" using 3:2 with linespoints ls 1 title '{/Helvetica=28 our traces}', \
  "" using 5:2 with linespoints ls 2 title '{/Helvetica=28 OSDI06}', \
  "" using 6:2 with linespoints ls 3 title '{/Helvetica=28 SIGCOMM08}'
