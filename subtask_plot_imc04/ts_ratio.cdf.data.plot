...
file_name = "ts_ratio.cdf.data"
fig_name  = "ts_ratio.cdf.data"
...
plot data_dir.file_name.".txt" using 3:1 with linespoints ls 1 title '{/Helvetica=28 our traces}', \
  "" using 5:1 with linespoints ls 2 title '{/Helvetica=28 OSDI06}', \
  "" using 6:1 with linespoints ls 3 title '{/Helvetica=28 SIGCOMM08}'
