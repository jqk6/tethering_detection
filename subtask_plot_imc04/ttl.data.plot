...
file_name = "ttl.num.data"
fig_name  = "ttl.num.data"
set output fig_dir.fig_name.".eps"

# set xlabel '{/Helvetica=28 # of distinct TTL values}'
set ylabel '{/Helvetica=28 Frac. of machines}'
...
# set key right top
set key at 2.4,0.95 samplen 2 width -1 ## coordinate of right top corner of the legend
...
plot data_dir.file_name.".txt" using 2:xtic(1) fs pattern 2 ls 1 title '{/Helvetica=28 1 TTL}', \
     "" using 3:xtic(1) fs pattern 3 ls 2 title '{/Helvetica=28 2 TTL}'
