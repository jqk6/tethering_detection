...
file_name = "freq_stdev.data.testbed"
fig_name  = "freq_stdev.data.testbed"
set output fig_dir.fig_name.".eps"

set xlabel '{/Helvetica=28 Std of calculated frequency}' offset character 0, 0, 0
...
data_dir = "../processed_data/subtask_plot_imc14/data/"
fig_dir  = "../processed_data/subtask_plot_imc14/figures/"
file_name = "freq_stdev.data.osdi06"
fig_name  = "freq_stdev.data.osdi06"
set output fig_dir.fig_name.".eps"
...
data_dir = "../processed_data/subtask_plot_imc14/data/"
fig_dir  = "../processed_data/subtask_plot_imc14/figures/"
file_name = "freq_stdev.data.sigcomm08"
fig_name  = "freq_stdev.data.sigcomm08"
set output fig_dir.fig_name.".eps"
...
data_dir = "../processed_data/subtask_plot_imc14/data/"
fig_dir  = "../processed_data/subtask_plot_imc14/figures/"
file_name = "freq_stdev.data"
fig_name  = "freq_stdev.data"
set output fig_dir.fig_name.".eps"
...
set key right top samplen 2 width -1
# set key Left above reverse nobox horizontal spacing 0.9 samplen 1.5 width -1
# set nokey
...
plot data_dir.file_name.".testbed.txt" using 3:1 with linespoints ls 1 title '{/Helvetica=22 Ours:tethering}', \
     data_dir.file_name.".testbed.txt" using 4:1 with linespoints ls 2 title '{/Helvetica=22 Ours:untethered}', \
     data_dir.file_name.".osdi06.txt" using 3:1 with linespoints ls 3 title '{/Helvetica=22 OSDI06:tethering}', \
     data_dir.file_name.".osdi06.txt" using 4:1 with linespoints ls 4 title '{/Helvetica=22 OSDI06:untethered}', \
     data_dir.file_name.".sigcomm08.txt" using 3:1 with linespoints ls 5 title '{/Helvetica=22 SIGCOMM08:tethering}', \
     data_dir.file_name.".sigcomm08.txt" using 4:1 with linespoints ls 6 title '{/Helvetica=22 SIGCOMM08:untethered}'
