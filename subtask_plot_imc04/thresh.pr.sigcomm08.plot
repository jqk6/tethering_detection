...
file_name = "thresh.pr.sigcomm08"
fig_name  = "thresh.pr.sigcomm08"
...
# set key right top
set key at 1,0.9 samplen 2 width -1 ## coordinate of right top corner of the legend
...
plot data_dir.file_name.".txt" using 1:3 with lines ls 1 title '{/Helvetica=28 Precision}', \
     data_dir.file_name.".txt" using 1:2 with lines ls 2 title '{/Helvetica=28 Recall}'
